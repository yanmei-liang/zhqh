<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="RECORDList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="批准日期" align="center" prop="approvalTime" width="180">
      ...
      <el-table-column label="批复文件" align="center" prop="approvalDocument" />
      ...
      <el-table-column label="新增矢量地名" align="center" prop="vectorPlaceName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="批复文件" prop="approvalDocument">
          <el-input v-model="form.approvalDocument" placeholder="请输入批复文件" />
        </el-form-item>
        <el-form-item label="命名申请书" prop="APPLICATION">
...
<script>
import { listRECORD, getRECORD, delRECORD, addRECORD, updateRECORD } from "@/api/government/RECORD";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除地名备案编号为"' + recordIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('government/RECORD/export', {
        ...this.queryParams
